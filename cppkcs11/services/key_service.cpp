                       ...
                       const std::vector<std::reference_wrapper<IAttribute>> &attrs)
{
    ...
    derivation_parameter.insert(derivation_parameter.begin(), iv.begin(), iv.end());
    derivation_parameter.insert(derivation_parameter.begin(), derivation_data.begin(),
                                derivation_data.end());
    ...
    auto native_attributes = as_native_attributes_v(attrs);
    ret                    = PKCSAPI::derive_key_(session_.native_handle(), &mechanism,
                               base_key.native_handle(), native_attributes.data(),
